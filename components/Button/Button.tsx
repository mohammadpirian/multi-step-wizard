...
const colorMap = {
  primary: {
    bg: "bg-m-dark-500",
    bgFade: "bg-m-dark-500/10",
    border: "border-m-dark-500",
    text: "text-white",
    textVariant: "text-m-dark-500 text-base",
    ring: " hover:ring-blue-500/40",
  },
  secondary: {
    bg: "bg-m-green-500",
    bgFade: "bg-m-green-500/30",
  ...
  danger: {
    bg: "bg-m-pink-600",
    bgFade: "bg-m-pink-600/10",
    border: "border-m-pink-600",
    text: "text-white",
    textVariant: "text-m-pink-600",
    ring: "hover:ring-2 hover:ring-offset-2 hover:ring-offset-rose-200 hover:ring-m-pink-600/40",
  },
  info: {
    bg: "bg-info",
    bgFade: "bg-info/10",
